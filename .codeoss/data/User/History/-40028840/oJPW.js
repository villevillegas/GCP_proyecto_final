...
app.post('/', async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      console.log(newPhoneCharge.toString());
      console.log(newPhoneCharge);
      console.log("enviando222222");
      console.log(JSON.parse(newPhoneCharge));
      console.log(JSON.parse(newPhoneCharge.toString()));
      console.log("enviando333333");
      await axios.post(ingressEndpoint, JSON.parse(newPhoneCharge), {
        headers: {
...
const topicName = 'projects/final-project-465717/topics/phone_refill_topic';
const ingressEndpoint = 'https://sell-registration-service-128392773449.us-central1.run.app/charges'; // Replace with your Ingress endpoint
...
const messageHandler = async message => {
  console.log("TESTING THE SUBSCRIBER");
